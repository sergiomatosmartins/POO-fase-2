...
use SMM\Model\CadastroClientes;
...
$CadatroClientes = new CadastroClientes();
$CadatroClientes->carregaDadosCliente();

$cliente = $CadatroClientes->pesquisaCliente($numCliente);
